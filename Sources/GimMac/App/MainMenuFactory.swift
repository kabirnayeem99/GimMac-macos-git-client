...
enum MainMenuFactory {
    ...
    static let manageStashesAction = #selector(MainSplitViewController.menuManageStashes(_:))
    ...
    private static func buildBranchMenu() -> NSMenu {
        ...
        menu.addItem(responderItem("Manage Stashes…", action: manageStashesAction))
