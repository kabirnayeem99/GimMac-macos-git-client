...
DERIVED_DATA_PATH="${DERIVED_DATA_PATH:-/private/tmp/${PROJECT_NAME}StrictCI}"
...
xcodebuild \
  ...
  OTHER_SWIFT_FLAGS="-warnings-as-errors -Xfrontend -disable-sandbox -Xfrontend -warn-long-function-bodies=80 -Xfrontend -warn-long-expression-type-checking=120" \
